plot4.R <- function() {
#   This function creates the Plot 4 as specified in the Course Project 1 for
#   Exploratory Data Analysis
    ...
    # Generate the plot
    par(mfrow=c(2,2))
    plot(requiredData$Date_Time, requiredData$Global_active_power, 
         type="l", 
         ylab="Global Active Power", xlab="")
    
    plot(requiredData$Date_Time, requiredData$Voltage, 
         type="l", 
    ...
    plot(requiredData$Date_Time, requiredData$Global_reactive_power, 
         type="l", 
         xlab="datetime",
